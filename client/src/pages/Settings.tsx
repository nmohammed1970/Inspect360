                              ...
                              <TooltipProvider>
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <div className="h-40 w-40 border-2 border-dashed border-border rounded-md flex flex-col items-center justify-center gap-2 bg-muted/50 opacity-50 cursor-not-allowed">
                                      <Upload className="w-10 h-10 text-muted-foreground" />
                                      <span className="text-sm text-muted-foreground">Premium Only</span>
                                    </div>
                                  </TooltipTrigger>
                                  <TooltipContent>
                                    <p>Please enable this feature from marketplace first.</p>
                                  </TooltipContent>
                                </Tooltip>
                              </TooltipProvider>
                            ) : (
                                  ...
                                  >
                                    ...
                                    <div className="absolute top-1 right-1 flex flex-col gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                      <Button
                                        ...
                                        disabled={index === 0 || reorderTrademarksMutation.isPending || !isWhiteLabelEnabled}
                                      ...
                                      <Button
                                        ...
                                        disabled={index === trademarks.length - 1 || reorderTrademarksMutation.isPending || !isWhiteLabelEnabled}
                              ...
                              {trademarks.length < 10 && (
                                !isWhiteLabelEnabled ? (
                                  <TooltipProvider>
                                    <Tooltip>
                                      <TooltipTrigger asChild>
                                        <div className="w-full aspect-square border-2 border-dashed border-border rounded-md flex flex-col items-center justify-center gap-2 bg-muted/50 opacity-50 cursor-not-allowed">
                                          <Upload className="w-6 h-6 text-muted-foreground" />
                                          <span className="text-xs text-muted-foreground text-center">Premium Only</span>
                                        </div>
                                      </TooltipTrigger>
                                      <TooltipContent>
                                        <p>Please enable this feature from marketplace first.</p>
